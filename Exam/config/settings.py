...
EMAIL_PORT = 465  # 端口
EMAIL_HOST_USER = '360679877@qq.com'  # 发件邮箱
EMAIL_HOST_PASSWORD = 'mzawjnawwpzxbicj'  # 密码
SERVER_EMAIL = EMAIL_HOST_USER  # 服务器邮箱
DEFAULT_FROM_EMAIL = '乐途旅行网<360679877@qq.com>' # 默认发件人
ADMINS = [('Admin', '734563686@qq.com')]  # 管理员邮箱
# 错误信息邮件设置
